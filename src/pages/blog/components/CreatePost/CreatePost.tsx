    ...
    <form onSubmit={handleSubmit} onReset={handleCancelEditingPost}>
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormData((prev: Post) => ({ ...prev, title: event.target.value }))}
        />
      </div>
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormData((prev: Post) => ({ ...prev, featuredImage: event.target.value }))}
        />
      </div>
      <div className='mb-6'>
        <div>
          ...
          <textarea
            ...
            onChange={(event) => setFormData((prev: Post) => ({ ...prev, description: event.target.value }))}
          />
        </div>
      </div>
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormData((prev: Post) => ({ ...prev, publishDate: event.target.value }))}
        />
      </div>
      <div className='mb-6 flex items-center'>
        <input
          ...
          onChange={(event) => setFormData((prev: Post) => ({ ...prev, published: event.target.checked }))}
